...
public class EntitySpawn implements Listener {
    public static List<EntityType> allowed = Arrays.asList(EntityType.PLAYER, EntityType.ARMOR_STAND, EntityType.ITEM_FRAME,
            EntityType.ARROW, EntityType.BOAT, EntityType.DROPPED_ITEM, EntityType.COMPLEX_PART,
            EntityType.EXPERIENCE_ORB, EntityType.FALLING_BLOCK, EntityType.FIREBALL, EntityType.FIREWORK,
            EntityType.FISHING_HOOK, EntityType.LIGHTNING, EntityType.PAINTING, EntityType.SPECTRAL_ARROW,
