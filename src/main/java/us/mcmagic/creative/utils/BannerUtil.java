...
public class BannerUtil {
    ...
    public BannerUtil() {
        ...
        colors.put("red", new ItemCreator(Material.WOOL, 1, (byte) 14, ChatColor.DARK_RED + "Red", empty));
        colors.put("orange", new ItemCreator(Material.WOOL, 1, (byte) 1, ChatColor.GOLD + "Orange", empty));
        colors.put("yellow", new ItemCreator(Material.WOOL, 1, (byte) 4, ChatColor.YELLOW + "Yellow", empty));
        colors.put("lime", new ItemCreator(Material.WOOL, 1, (byte) 5, ChatColor.GREEN + "Lime", empty));
        colors.put("green", new ItemCreator(Material.WOOL, 1, (byte) 13, ChatColor.DARK_GREEN + "Green", empty));
        colors.put("lightblue", new ItemCreator(Material.WOOL, 1, (byte) 3, ChatColor.AQUA + "Light Blue", empty));
        colors.put("cyan", new ItemCreator(Material.WOOL, 1, (byte) 9, ChatColor.DARK_AQUA + "Cyan", empty));
        colors.put("blue", new ItemCreator(Material.WOOL, 1, (byte) 11, ChatColor.BLUE + "Blue", empty));
        colors.put("purple", new ItemCreator(Material.WOOL, 1, (byte) 10, ChatColor.DARK_PURPLE + "Purple", empty));
        colors.put("magenta", new ItemCreator(Material.WOOL, 1, (byte) 2, ChatColor.LIGHT_PURPLE + "Magenta", empty));
        colors.put("pink", new ItemCreator(Material.WOOL, 1, (byte) 6, ChatColor.RED + "Pink", empty));
        colors.put("brown", new ItemCreator(Material.WOOL, 1, (byte) 12, ChatColor.DARK_GRAY + "Brown", empty));
        colors.put("gray", new ItemCreator(Material.WOOL, 1, (byte) 8, ChatColor.GRAY + "Gray", empty));
        colors.put("darkgray", new ItemCreator(Material.WOOL, 1, (byte) 7, ChatColor.DARK_GRAY + "Dark Gray", empty));
        colors.put("white", new ItemCreator(Material.WOOL, 1, (byte) 0, ChatColor.WHITE + "White", empty));
        colors.put("black", new ItemCreator(Material.WOOL, 1, (byte) 15, ChatColor.DARK_GRAY + "Black", empty));
        /**
         * --Banners--
         */
    ...
    public void openMenu(Player player, BannerInventoryType type) {
        ...
        if (userBanners.containsKey(player.getUniqueId())) {
            ...
            banner = new ItemCreator(Material.BANNER, ChatColor.WHITE + "Your Banner");
    ...
    private ItemStack getExampleBanner(PatternType type, String name) {
        ItemStack banner = new ItemCreator(Material.BANNER, name);
        BannerMeta bm = (BannerMeta) banner.getItemMeta();
